...
print_steps = 999999													#Number of simulation steps after which an update of the linker position and extension is stored. print_steps can be set to MaxSteps-1 for simulations that only store information on the dissociation time, but no information on the linker position.
