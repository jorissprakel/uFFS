...
outcon,detached,steps,T,N_linkers,X_positions,Q_angles,Nass_lst,Ndiss_lst=rollingbead_f.start_simulation(par,path_to_simfolder)	#Performs the KMC simulations
